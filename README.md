...
- Apri Illustrator e carica lo script

  - (File → Scripts → Other Script...
  - oppure trascina nello script panel se usi un loader).
...
- _Increment_: le percentuali sono lineari rispetto alla dimensione originale (no compounding).
- _Range_: Start/End sono interpretati come percentuale della dimensione originale (100 = originale).
- _Anchor_: lo script ridimensiona e poi riposiziona per mantenere fisso il pivot selezionato.
- _Layer Order_: ordina secondo z-order; attenzione a selezioni multi-layer o gruppi complessi.
